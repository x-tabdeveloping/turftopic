...
# Pretokenizing the stop word list
chinese_stop_words = list(
    itertools.chain.from_iterable(map(tokenize_zh, chinese_stop_words))
)
...
def default_chinese_vectorizer():
    return ChineseCountVectorizer(stop_words="chinese", min_df=10)
